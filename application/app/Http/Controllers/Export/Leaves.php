...
class Leaves extends Controller {
    ...
    /**
     * Export leaves to XLSX file
     * @return download
     */
    public function index(LeavesExport $export) {

        //temp directory
        $directory = Str::random(30);

        //file name
        $filename = __('lang.leaves') . '.xlsx';
        ...
        try {
            ...
            Log::error("exporting leaves failed", ['process' => '[permissions]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__, 'error_message' => $error_message]);
            //default error
