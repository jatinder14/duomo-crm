 ...
 * @return string css
 */
function runtimeDisabledAttendancesCheckboxes($var = false) {
    if ($var) {
        return 'disabled';
    }
}
 ...
 * @return string css
 */
function runtimeDisabledHolidaysCheckboxes($var = false) {
    if ($var) {
        return 'disabled';
    }
}
 ...
 * @return string css
 */
function runtimeDisabledLeavesCheckboxes($var = false) {
    if ($var) {
        return 'disabled';
    }
}
