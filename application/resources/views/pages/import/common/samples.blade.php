...
@if ($type == 'attendances')
    <div class="x-splash-failed-text">
        <a href="{{ url('storage/system/samples/import-attendances.csv') }}" download>@lang('lang.csv_sample')</a>
        | <a href="{{ url('storage/system/samples/import-attendances.xlsx') }}" download>@lang('lang.xlsx_sample')</a>
    </div>
@endif
