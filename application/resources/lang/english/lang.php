...
return [
    ...
    'filter_attendances' => 'Filter Attendances',
    'in_time' => "In Time",
    'out_time' => "Out Time",
    'reason' => 'Reason',
    'leave' => 'Leave',
    ...
    'filter_holidays' => 'Filter Holidays',
    'date_from' => 'Date From',
    'date_to' => 'Date To',
    'out_time_must_be_greater_than_or_equal_to_in_time' => 'The out time must be greater then or equal to in time.',
    'date_to_must_be_greater_than_or_equal_to_date_from' => 'The date to must be grether then or equal to date from.',
    'foo' => "bar",
    'foo' => "bar",
    'foo' => "bar",
    'foo' => "bar",
